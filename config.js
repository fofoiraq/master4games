...
var config = { // NOTE: DO NOT LEAVE ANYTHING BLANK
  ...
  musicEnabled: 'true',
	...
	dashboard: {
		...
		domain: 'master4games.herokuapp.com', // Domain name (with port if not running behind proxy running on port 80). Example: 'domain': 'dashboard.bot-website.com' OR 'domain': 'localhost:33445'
