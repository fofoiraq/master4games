...
var config = { // NOTE: DO NOT LEAVE ANYTHING BLANK
	...
	ownerID: '201632163991519233', // Your ID here
	token: 'NDkxMzkzNDkzMDQyOTg3MDE4.Dqv7xA.F82QPikBViNYAQv4NUIg5VrH2Pk', // Your bot token here
	...
	playingGame: 'Master4Games Army', // The game you want the bot to play. {{prefix}} is replaced with the default prefix below, {{guilds}} is replaced with the guild count and {{version}} is replaced with the bot version. Leave blank to disable
  ...
  googleAPIToken: 'AIzaSyAQwuW_U7TtA2MZwHiRv1vZ6ga9s7YUSXA', // Used for link shortener and music features. You need to have these APIs enabled.
  ...
  musicEnabled: 'true',
	...
	dashboard: {
		...
		domain: 'master4games.herokuapp.com:8080', // Domain name (with port if not running behind proxy running on port 80). Example: 'domain': 'dashboard.bot-website.com' OR 'domain': 'localhost:33445'
